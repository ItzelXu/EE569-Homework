...
int main(int argc, char* argv[])
{
	...
	//Image File Names
	char toy_input[256];
	char toy_equalizedB[50] = "Images/Toy_equalizedB.raw";
	...
	Image toyEqualizedB(toy_width, toy_height, bpp, toy_equalizedB);

	//Initialize Objects
	toyInput.initialize();
	toyEqualizedB.initialize();
	...
	toyInput.imgHistoAcumulative(toyEqualizedB);

	//Write Results in Files
	toyEqualizedB.writeFile();
}